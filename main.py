...
# klasa account (odpowiada za przechowywanie danych konta), klasa operation
# Takie konto jest niedostępne
...
class Database:
    ...
    def insert_income(self, insert_amount):
        self.cursor.execute(f'INSERT INTO card (balance) VALUES (new_balance)')
    ...
    def delete_table(self, card_number):
        self.cursor.execute('DELETE FROM card WHERE "row_number() over ()" = card_number')
            ...
            if bank_account.if_login(data, entered_card_number, entered_pin):
                ...
                while True:
                    ...
                    if choice_tologin == 1:
                        ...
                        pass
                    elif choice_tologin == 3:
                        pass
                    elif choice_tologin == 4:
                        pass
                    elif choice_tologin == 5:
